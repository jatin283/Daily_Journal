...
app.get("/posts/:topic",function(req,res){
  ...
  for(var i=0;i<posts.length; i++){
    const searchedtopic=_.lowerCase(posts[i].title);
    const searchedcontent=posts[i].content;
    if(requestedtopic===searchedtopic){
      res.render("post",{posttitle:searchedtopic, postcontent:searchedcontent});
    }
  }
});
